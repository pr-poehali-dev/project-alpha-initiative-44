        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  <Icon name="Send" className="h-3 w-3 text-foreground/60" />
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Работаем</span>
                </div>
                <p className="text-base text-foreground md:text-2xl">По всей России</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Телефон или Email</label>
                <input
                  type="email"
                  ...
                  required
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="your@email.com или +7 999..."
                />
              </div>
              ...
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Расскажите о клинике</label>
                <textarea
                  rows={3}
                  ...
                  required
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Название клиники, специализация, город..."
                />
              </div>
